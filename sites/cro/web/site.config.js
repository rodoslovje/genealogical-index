...
const siteConfig = {
  ...
  intro: {
    en: [
      ...
      { text: 'The application offers advanced search, sorting, and data export options. For detailed instructions on using all features, please see the <a href="#" onclick="document.getElementById(\'help-toggle-btn\')?.click(); return false;">User Guide</a>.' },
    ...
    sl: [
      ...
      { text: 'Indeks je sestavljen iz podatkov v datotekah GEDCOM, ki so nam jih posredovali številni rodoslovci, navedeni na strani <a href="?t=contributors">Viri</a>.' },
      { text: 'Opozorilo! Hrvaški rodoslovni indeks je informativnega značaja. Hrvaško rodoslovno društvo »Pavao Ritter Vitezović« se odreka vsakršni odgovornosti za pravilnost posredovanih podatkov. Društvo je prostovoljna povezava posameznikov, ki razvijajo skupni vir znanja o podatkih iz matičnih registrov ter drugih pisnih in ustnih virov. Struktura društva omogoča, da lahko vsak, ki ima svojo zbirko rodoslovnih podatkov, to prispeva v skupno združeno zbirko in indeks. Za pravilnost podatkov ne jamči niti posameznik, ki jih je prispeval, niti Hrvaško rodoslovno društvo »Pavao Ritter Vitezović«.', warning: true },
    ...
    hr: [
      ...
      { text: 'Aplikacija nudi napredne mogućnosti pretraživanja, razvrstavanja i izvoza podataka. Za detaljnije upute o korištenju svih funkcionalnosti pogledajte <a href="#" onclick="document.getElementById(\'help-toggle-btn\')?.click(); return false;">upute za korištenje</a>.' },
      { text: 'Indeks obitelji može uključivati i roditelje koji se nikada nisu vjenčali ili čak nikada nisu živjeli zajedno, što može biti dragocjen podatak za potomke i druge istraživače.' },
      { text: 'Indeks je sastavljen od podataka iz datoteka GEDCOM koje su nam ustupili brojni rodoslovci, navedeni na stranici <a href="?t=contributors">Izvori</a>.' },
      { text: 'Upozorenje! Hrvatski rodoslovni indeks isključivo je informativnog karaktera. Hrvatsko rodoslovno društvo „Pavao Ritter Vitezović” odriče se svake odgovornosti za točnost dostavljenih podataka. Društvo je dobrovoljno udruženje pojedinaca koji razvijaju zajednički izvor znanja o podacima iz matičnih knjiga te drugih pisanih i usmenih izvora. Struktura društva omogućuje svakome tko ima vlastitu zbirku rodoslovnih podataka da je pridruži zajedničkoj objedinjenoj zbirci i indeksu. Za točnost podataka ne jamči ni pojedinac koji ih je priložio ni Hrvatsko rodoslovno društvo „Pavao Ritter Vitezović”.', warning: true },
      { text: 'Ako vlastito obiteljsko stablo vodite u obliku baze podataka i želite se s rezultatima svojeg rada pridružiti dosadašnjim suradnicima, izvezite podatke u datoteku GEDCOM (bez podataka o živim osobama) i pošaljite je administratoru <a href="mailto:rodoslovlje@rodoslovlje.hr">e-poštom</a>.' },
    ],
    hu: [
      ...
      { text: 'Az alkalmazás fejlett keresési, rendezési és adatexportálási lehetőségeket kínál. Az összes funkció használatára vonatkozó részletes utasításokért tekintse meg a <a href="#" onclick="document.getElementById(\'help-toggle-btn\')?.click(); return false;">Felhasználói kézikönyvet</a>.' },
      ...
      { text: 'Az index a GEDCOM-fájlokban található adatokból áll össze, amelyeket számos genealógus küldött el nekünk; ők a <a href="?t=contributors">Források</a> oldalon vannak felsorolva.' },
    ...
    de: [
      ...
      { text: 'Der Index entsteht aus Daten in GEDCOM-Dateien, die uns zahlreiche Genealogen zur Verfügung gestellt haben; sie sind auf der Seite <a href="?t=contributors">Quellen</a> aufgeführt.' },
    ...
    it: [
      ...
      { text: 'L\'applicazione offre opzioni avanzate di ricerca, ordinamento ed esportazione dei dati. Per istruzioni dettagliate sull\'utilizzo di tutte le funzionalità, consultare il <a href="#" onclick="document.getElementById(\'help-toggle-btn\')?.click(); return false;">Guida utente</a>.' },
      ...
      { text: 'L\'indice è composto da dati provenienti da file GEDCOM che ci sono stati forniti da numerosi genealogisti, elencati nella pagina <a href="?t=contributors">Fonti</a>.' },
