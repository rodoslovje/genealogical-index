...
const siteConfig = {
  ...
  intro: {
    ...
    hr: [
      ...
      { text: 'Aplikacija nudi napredne mogućnosti pretraživanja, sortiranja i izvoza podataka. Za detaljnije upute o korištenju svih funkcionalnosti pogledajte <a href="#" onclick="document.getElementById(\'help-toggle-btn\')?.click(); return false;">Korisnički vodič</a>.' },
