export default {
    ...
    matricula_books_summary: 'A(z) {0} genealógusnak {1} könyve van összesen {2} bejegyzéssel a <a href="{3}" data-spa-nav>Matricula indexben</a>.',
    ...
    matricula_section_contributors: 'Genealógusok',
