export default {
    ...
    chart_surnames_select: 'Select source…',
    ...
    loading_contributors: 'Loading sources...',
    ...
    matricula_page_intro: 'Global statistics over all Matricula Online books transcribed by genealogists in this index',
    ...
    matricula_intro: 'As part of the <a href="{0}" target="_blank" rel="noopener">Indeks matičnih knjig NŠA-LJ, NŠAM in ŠAK</a> project, individual genealogists can contribute an index of entire parish registers (baptisms, marriages or deaths) on <a href="{1}" target="_blank" rel="noopener">Matricula Online</a>.',
    geneanet_intro: 'As part of the <a href="{0}" target="_blank" rel="noopener">Register slovenskih pokopališč</a> project, individual genealogists can contribute photographs of gravestones, which are indexed within the project on <a href="{1}" target="_blank" rel="noopener">Geneanet Cemeteries</a>.',
