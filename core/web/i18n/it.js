export default {
    ...
    matricula_books_summary: 'Il genealogista {0} ha {1} registri con un totale di {2} voci nell\'<a href="{3}" data-spa-nav>Indice Matricula</a>.',
    ...
    matricula_section_contributors: 'Genealogisti',
