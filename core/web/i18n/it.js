export default {
    ...
    matches_found_intro: 'Abbiamo trovato le seguenti fonti che hanno dati corrispondenti o simili a',
    ...
    help_manual: `
      ...
      <ul>
        <li><strong>Fonte:</strong> Nel campo di ricerca è possibile inserire il cognome di uno o più genealogisti, separati da virgole. Utilizzando il menu a discesa accanto, è inoltre possibile limitare la ricerca a un tipo di fonte specifico: <em>Alberi genealogici</em>, <em>Indice Matricula</em> o <em>Cimiteri Geneanet</em> (per impostazione predefinita sono incluse tutte le fonti).</li>
      ...
      <ul>
        ...
        <li><strong>Filtrare l'elenco:</strong> Il campo di ricerca accanto al titolo della tabella permette di restringere rapidamente l'elenco in base al cognome del genealogista. La nuvola dei cognomi più frequenti mostrerà allora soltanto i cognomi dagli alberi dei genealogisti trovati.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Differenze evidenziate:</strong> I campi in cui i valori non corrispondono tra i due genealogisti vengono evidenziati automaticamente in <span class="match-diff">giallo</span> nella tabella. I campi e i collegamenti (icona) presenti solo per l'altro genealogista vengono evidenziati in <span class="match-add">verde</span> — questo rende facile individuare nuove informazioni non ancora presenti nel proprio albero. Accanto al punteggio di confidenza possono inoltre apparire le etichette <span class="match-badge match-badge-add">+</span> (l'altro genealogista ha un dato per un campo qui mancante), <span class="match-badge match-badge-link">🔗</span> (l'altro genealogista ha un collegamento, ad es. a una fonte o a un registro di sepoltura, qui mancante) e <span class="match-badge match-badge-diff">≠</span> (i valori non corrispondono tra i due genealogisti), ciascuna con il numero di campi a cui si riferisce.</li>
