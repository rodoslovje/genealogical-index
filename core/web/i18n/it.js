export default {
    ...
    matches_filter_placeholder: 'Filtra per nome, luogo o data…',
    matricula_filter_placeholder: 'Filtra per parrocchia, tipo, data o genealogista…',
    ...
    geneanet_filter_placeholder: 'Filtra per luogo, cimitero o tipo…',
    ...
    tip_matches_filter: 'Filtra le righe per nome, luogo o data.',
