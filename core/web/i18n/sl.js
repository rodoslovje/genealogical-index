export default {
    ...
    section_matricula_books: 'Transkribirane Matricula matične knjige',
    ...
    col_total_records: 'Zapisi',
    col_contributors_count: 'Rodoslovci',
    ...
    matricula_books_label: 'knjig',
    matricula_records_label: 'zapisov',
    matricula_section_books: 'Vse indeksirane knjige',
    matricula_section_top_contributors: 'Najbolj aktivni rodoslovci',
    matricula_section_top_parishes: 'Najpogostejše župnije',
    matricula_more_stats: 'Statistika za Matricula indeks',
    book_type_birth: 'Krsti',
    book_type_marriage: 'Poroke',
