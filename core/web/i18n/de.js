export default {
    ...
    table_filter_csv_label: 'Filter',
    date_to: 'bis Jahr',
    download_csv: 'Als CSV herunterladen — zum Importieren in eine Tabellenkalkulation oder andere Programme.',
    expand_all: 'Ausklappen',
    collapse_all: 'Einklappen',
    tip_expand_all: 'Alle aufklappbaren Zellen (Eltern, Partner, Kinder) in dieser Tabelle erweitern.',
    tip_collapse_all: 'Alle erweiterten Zellen in dieser Tabelle einklappen.',
    general_search_label: 'Allgemein',
    help: 'Hilfe',
    language: 'Sprache',
    label_source: 'Quelle',
    source_all: 'Alle',
    source_tree: 'Stammbäume',
    source_matricula: 'Matricula-Index',
    menu: 'Menü',
    chart_others: 'Andere',
    chart_timeline: 'Zeitverlauf der Einträge',
    chart_surnames_title: 'Häufigste Nachnamen pro Quelle',
    table_filter_placeholder: 'Tabelle filtern…',
    source_geneanet: 'Geneanet Friedhöfe',
    source_military: 'Militärquellen',
    icon_geneanet_index: 'Geneanet Friedhöfe',
    icon_military_index: 'Militärquellen',
    label_burial: 'Beerdigung',
    col_date_of_burial: 'Datum der Beerdigung',
    col_place_of_burial: 'Ort der Beerdigung',
    col_cemetery: 'Friedhof',
    ...
    chart_surnames_all: 'Alle Quellen',
    ...
    contributors_failed: 'Quellendaten konnten nicht geladen werden.',
    ...
    col_contributor: 'Quelle',
    col_date_of_death: 'Sterbedatum',
    col_place_of_death: 'Sterbeort',
    col_alt_surname: 'Alternativer Nachname',
    col_date_of_baptism: 'Taufdatum',
    col_place_of_baptism: 'Taufort',
    col_notes: 'Notizen',
    col_partner: 'Partner',
    ...
    col_father: 'Vater',
    col_mother: 'Mutter',
    col_husband_father: 'Vater des Mannes',
    col_husband_mother: 'Mutter des Mannes',
    col_wife_father: 'Vater der Frau',
    col_wife_mother: 'Mutter der Frau',
    ...
    col_contributor_ID: 'Quelle',
    col_total_persons: 'Personen',
    col_total_families: 'Familien',
    col_total: 'Gesamt',
    col_last_modified: 'Aktualisiert',
    col_links: 'Links',
    ...
    matches_found_intro: 'Wir haben die folgenden Quellen gefunden, die übereinstimmende oder ähnliche Daten aufweisen wie die Quelle',
    matches_found_outro: 'Wählen Sie eine übereinstimmende Quelle aus, um alle Übereinstimmungen zwischen den beiden anzuzeigen.',
    matches_detail_intro: 'Alle Übereinstimmungen zwischen {1} und {0} werden unten angezeigt.',
    matches_truncated: 'Es {0|wird die # stärkste|werden die # stärksten} von {1|# Übereinstimmung|# Übereinstimmungen} angezeigt.',
    ...
    contributor_surnames_intro: 'Die Quelle',
    contributor_surnames_outro: 'hat die folgenden häufigsten Nachnamen:',
    ...
    matricula_books_summary: 'Die Quelle {0} hat {1|# Buch|# Bücher} mit insgesamt {2|# Eintrag|# Einträgen} im <a href="{3}" data-spa-nav>Matricula-Index</a>.',
    section_geneanet_cemeteries: 'Fotografierte und indexierte Friedhöfe',
    geneanet_cemeteries_summary: 'Die Quelle {0} hat {1|# Friedhof|# Friedhöfe} mit insgesamt {2|# Person|# Personen} in den <a href="{3}" data-spa-nav>Geneanet Friedhöfen</a>.',
    ...
    col_book_type: 'Typ',
    col_book_count: 'Einträge',
    col_books_count: 'Bücher',
    matricula_page_title: 'Matricula-Index',
    matricula_section_books: 'Transkribierte Bücher',
    matricula_section_contributors: 'Quellen',
    matricula_section_parishes: 'Pfarreien',
    contributors_index_links_intro: 'Auch detaillierte Statistiken zum {0} und zu den {1} sind verfügbar.',
    matricula_intro: 'Im Rahmen des Projekts <a href="{0}" target="_blank" rel="noopener">Index der Matrikelbücher von NŠA-LJ, NŠAM und ŠAK</a> können einzelne Genealogen einen Index ganzer Matrikelbücher (Tauf-, Trauungs- oder Sterbebücher) auf <a href="{1}" target="_blank" rel="noopener">Matricula Online</a> beitragen.',
    geneanet_intro: 'Im Rahmen des Projekts <a href="{0}" target="_blank" rel="noopener">Register der slowenischen Friedhöfe</a> können einzelne Genealogen Fotos von Grabsteinen beitragen, die im Rahmen des Projekts auf <a href="{1}" target="_blank" rel="noopener">Geneanet Friedhöfe</a> indexiert werden.',
    book_type_birth: 'Taufe',
    book_type_marriage: 'Heirat',
    book_type_death: 'Tod',
    more_info_about: 'Weitere Informationen über die Quelle',
    memorial_title: 'Zum Gedenken',
    memorial_note: 'Diese genealogische Arbeit bleibt hier veröffentlicht, in Erinnerung und Dankbarkeit.',
    memorial_page: 'Gedenkseite',
    back_to_genealogists: 'Quellen',
    genealogist: 'Quelle',
    ...
    footer_user_guide: 'Benutzerhandbuch',
    footer_changelog: 'Neuerungen',
    changelog_title: 'Was ist neu',
    changelog_intro: 'Neue Funktionen und Verbesserungen, die neuesten zuerst. Kleinere Korrekturen sind nicht aufgeführt.',
    ...
    tree_download_csv: 'Als CSV herunterladen — zum Importieren in eine Tabellenkalkulation oder andere Programme.',
    tree_download_ged: 'GEDCOM herunterladen',
    ...
    help_auth_match: ' (diese Funktion steht nur angemeldeten Mitgliedern zur Verfügung)',
    help_auth_section: `
    ...
    help_source_marks: `<p>In der Spalte <em>Quelle</em> zeigt ein Zeichen hinter dem Namen, aus welcher Art von Quelle der Eintrag stammt — dieselben Arten, auf die sich die Suche einschränken lässt:</p>`,
    help_source_mark_matricula: `<li><strong>⛪</strong> – <em>Matricula-Index</em>: Einträge, die aus den gescannten Matrikelbüchern auf Matricula Online indexiert wurden</li>`,
    help_source_mark_geneanet: `<li><strong>🪦</strong> – <em>Geneanet Friedhöfe</em>: von Grabsteinen erfasste Einträge</li>`,
    help_source_mark_military: `<li><strong>🎖</strong> – <em>Militärquellen</em>: Einträge zu Kriegsopfern</li>`,
    help_source_mark_tree: `<li><strong>kein Zeichen</strong> – der eigene Stammbaum des Genealogen</li>`,
    help_source_type_item: `<li><strong>Quelle:</strong> In das Suchfeld können Sie den Namen einer oder mehrerer Quellen eingeben, getrennt durch Kommas. Über das Dropdown-Menü daneben können Sie die Suche zusätzlich auf einen bestimmten Quellentyp beschränken: <em>Stammbäume</em>, <em>Matricula-Index</em>, <em>Geneanet Friedhöfe</em> oder <em>Militärquellen</em> (standardmäßig sind alle Quellen eingeschlossen).</li>`,
    ...
    help_manual: `
      ...
      <h3>1. Übersicht und Navigation</h3>
      <p>Oben auf dem Bildschirm befindet sich das Hauptnavigationsmenü. Durch Klicken auf den Seitentitel kehren Sie immer zur Startseite zurück. Das Menü enthält vier Hauptreiter:</p>
      <ul>
      ...
      <h3>2. Wie suche ich im Index?</h3>
      <p>Der Index bietet eine flexible Suchmaschine auf der rechten Seite des Bildschirms. Öffnen Sie diese, indem Sie auf das Menüsymbol (<strong>☰</strong>) in der oberen rechten Ecke klicken. Der Inhalt der Suchmaschine passt sich dem ausgewählten Reiter an:</p>
      <ul>
        <li><strong>Suche:</strong> Die allgemeinste Suchmaschine – Sie können eine beliebige Kombination aus Vorname, Nachname, Datum und Ort in die Suchfelder eingeben, und die Suchmaschine zeigt zwei separate Ergebnistabellen an: gefundene Personen und gefundene Familien.</li>
        <li><strong>Person:</strong> Ermöglicht die präzise Suche nach einzelnen Lebensereignissen (genaues Datum und Ort von Geburt und Tod).</li>
        <li><strong>Familie:</strong> Ermöglicht die gleichzeitige Suche nach Daten von Mann und Frau (Vornamen, Nachnamen, Geburtsdaten), Datum und Ort der Heirat sowie die Suche nach den Vornamen der Kinder.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Tabelle filtern:</strong> Im Suchfeld neben dem Tabellentitel können Sie einen beliebigen Text eingeben, um nur die Zeilen zu behalten, die ihn in einer beliebigen Spalte enthalten.</li>
        ...
        <li><strong>Quelle:</strong> Die letzte Spalte nennt die Quelle, aus der der Eintrag stammt. Ein Klick auf den Namen öffnet die Seite dieser Quelle mit ihrer Statistik, den häufigsten Nachnamen und den Übereinstimmungen mit anderen Quellen. Ein <strong>🕯</strong> neben dem Namen kennzeichnet einen verstorbenen Genealogen; wo es eine Gedenkseite gibt, öffnet ein Klick auf die Kerze diese.</li>
        <li><strong>Stammbaum:</strong> Ein Baumsymbol (<strong>🌳</strong>) erscheint neben dem Nachnamen jeder Person, deren Verwandte bekannt sind. Ein Klick darauf öffnet einen interaktiven Stammbaum dieser Person: standardmäßig eine <em>Sanduhr</em>, die Vorfahren und Nachkommen zugleich zeigt und sich auf nur Vorfahren oder nur Nachkommen einschränken lässt. Die Darstellung kann ein <em>Fächer</em> sein (Standard, mit den Vorfahren in der oberen und den Nachkommen in der unteren Hälfte) oder ein klassischer <em>Baum</em> (Vorfahren links, Nachkommen rechts); werden nur Vorfahren oder nur Nachkommen gezeigt, lässt sich der Fächer auch zu einem vollen <em>Kreis</em> schließen. Die Ansicht kann auf eine gewählte Anzahl Generationen begrenzt und als SVG, CSV oder GEDCOM heruntergeladen werden.{auth_tree}</li>
      ...
      <h4>Symbole in den Zeilen</h4>
      <p>In der Spalte <em>Links</em> zeigen Symbole die Art der Originalquelle an, auf die sie verweisen:</p>
      <ul>
        <li><strong>📜</strong> – Matricula Online (Kirchenbücher)</li>
        <li><strong>🌳</strong> – FamilySearch (Kirchenbücher, Stammbäume und andere Quellen)</li>
        <li><strong>🪦</strong> – Gräber (Geneanet, Find a Grave, BillionGraves)</li>
      ...
      <ul>
        <li><strong>Werkzeugleiste:</strong> Über der Darstellung wählen Sie die Zeichnung (<em>Fächer</em> oder <em>Baum</em>), die Richtung (<em>Beides</em>, <em>Vorfahren</em> oder <em>Nachkommen</em>) und die Anzahl der angezeigten <em>Generationen</em>. Der Fächer beginnt bei sechs Generationen, der Baum zeigt alle; die angebotenen Werte reichen nur so tief wie die Daten selbst.</li>
        <li><strong>Eine Person öffnen:</strong> Ein Klick auf einen Namen in der Darstellung sucht diese Person im Index. Der Genealoge, aus dessen Baum die Darstellung stammt, wird in der unteren linken Ecke genannt.</li>
