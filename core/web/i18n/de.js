export default {
    ...
    section_matricula_books: 'Transkribierte Matricula-Matrikelbücher',
    matricula_books_intro: 'Bücher transkribiert von',
    matricula_books_outro: 'auf Matricula Online:',
    col_book_parish: 'Pfarrei',
    col_book_name: 'Buch',
    col_book_type: 'Typ',
    col_book_count: 'Einträge',
    col_books_count: 'Bücher',
    col_total_records: 'Einträge',
    col_contributors_count: 'Genealogen',
    ...
    matricula_books_label: 'Bücher',
    matricula_records_label: 'Einträge',
    ...
    matricula_more_stats: 'Globale Matricula-Statistik anzeigen',
