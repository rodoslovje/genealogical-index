export default {
    ...
    tip_collapse_all: 'Sažmi sve proširene ćelije u ovoj tablici.',
    ...
    chart_surnames_title: 'Najčešća prezimena po izvoru',
    table_filter_placeholder: 'Filtriraj tablicu…',
    source_geneanet: 'Geneanet groblja',
    source_military: 'Vojni izvori',
    icon_geneanet_index: 'Geneanet groblja',
    icon_military_index: 'Vojni izvori',
    label_burial: 'Pokop',
    col_date_of_burial: 'Datum pokopa',
    col_place_of_burial: 'Mjesto pokopa',
    col_cemetery: 'Groblje',
    col_persons: 'Osobe',
    col_graves: 'Grobovi',
    ...
    chart_surnames_all: 'Svi izvori',
    chart_surnames_select: 'Odaberi izvor…',
    ...
    loading_contributors: 'Učitavanje izvora...',
    ...
    col_father: 'Otac',
    col_mother: 'Majka',
    col_husband_father: 'Otac muža',
    col_husband_mother: 'Majka muža',
    col_wife_father: 'Otac žene',
    col_wife_mother: 'Majka žene',
    ...
    col_contributor_ID: 'Izvor',
    col_total_persons: 'Osobe',
    col_total_families: 'Obitelji',
    col_total: 'Ukupno',
    col_last_modified: 'Ažurirano',
    col_links: 'Poveznice',
    ...
    matches_found_intro: 'Pronašli smo sljedeće izvore koji imaju podudarne ili slične podatke kao',
    ...
    matricula_page_intro: 'Statistika svih knjiga Matricula Online koje su transkribirali rodoslovci u ovom indeksu',
    ...
    matricula_intro: 'U sklopu projekta <a href="{0}" target="_blank" rel="noopener">Indeks matičnih knjig NŠA-LJ, NŠAM in ŠAK</a> pojedini rodoslovci mogu doprinijeti indeksom cijelih matičnih knjiga (krštene, vjenčane ili umrle) na <a href="{1}" target="_blank" rel="noopener">Matricula Online</a>.',
    geneanet_intro: 'U sklopu projekta <a href="{0}" target="_blank" rel="noopener">Register slovenskih pokopališč</a> pojedini rodoslovci mogu doprinijeti fotografijama nadgrobnih spomenika, koje se u sklopu projekta indeksiraju na stranici <a href="{1}" target="_blank" rel="noopener">Geneanet groblja</a>.',
