...
const translations = {
  en: {
    ...
    matches_detail_intro: 'All matches between the selected genealogists are shown below.',
  ...
  sl: {
    ...
    matches_detail_intro: 'Prikazana so vsa ujemanja med izbranima rodoslovcema.',
  ...
  hr: {
    ...
    matches_detail_intro: 'Prikazana su sva podudaranja između odabranih rodoslovaca.',
  ...
  de: {
    ...
    matches_detail_intro: 'Alle Übereinstimmungen zwischen den ausgewählten Genealogen werden unten angezeigt.',
  ...
  hu: {
    ...
    matches_detail_intro: 'A kiválasztott genealógusok közötti összes egyezés alább látható.',
  ...
  it: {
    ...
    matches_detail_intro: 'Tutte le corrispondenze tra i genealogisti selezionati sono mostrate di seguito.',
