...
const introData = {
  en: [
    ...
    { text: 'The query results can be sorted by name or surname on both tabs. For a full view, it is possible to hide the query window. For foreign users of the index, the site is also available in English.' },
  ...
  sl: [
    ...
    { text: 'Rezultate poizvedbe lahko na obeh zavihkih razvrstite po imenih ali priimkih. Za polno pregledovanje je mogoče skriti poizvedbeno okno. Za tuje uporabnike indeksa pa je stran na voljo tudi v angleščini.' },
